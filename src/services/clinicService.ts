...
export const DEFAULT_CLINICS: Clinic[] = [
  {
    ...
    name: 'Teethly Beverly Hills Laser & Aesthetic Dentistry',
    logo: '/teethly.png',
    address: '9450 Wilshire Blvd, Suite 400, Beverly Hills, CA 90212',
    phone: '+1 (310) 555-0199',
    email: 'bh@teethly.clinic',
    website: 'https://bh.teethly.clinic',
  ...
  },
  {
    ...
    name: 'Teethly Specialist Dental Clinic & Orthodontic Center',
    ...
    email: 'lahore@teethly.clinic',
    website: 'https://lahore.teethly.clinic',
  ...
  },
  {
    ...
    name: 'Teethly Dubai Downtown Dental Lounge',
    ...
    email: 'dubai@teethly.clinic',
    website: 'https://dubai.teethly.clinic',
